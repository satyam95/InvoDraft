        ...
        <div className="space-y-18">
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <Link href="/signup">
                <Button
                  className="text-lg h-14 rounded-xl font-medium py-4 px-10 bg-btn-gradient gap-4 cursor-pointer transition-all duration-300 hover:scale-105 active:scale-95 shadow-md hover:shadow-lg"
            ...
            <section className="space-y-6 max-w-[396px]">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <Button
                    type="submit"
                    className="text-sm leading-[20px] h-11 rounded-xl font-medium py-3 px-8 bg-btn-gradient cursor-pointer transition-all duration-300 hover:scale-105 active:scale-95 shadow-md hover:shadow-lg"
                  >
                    Subscribe
                  </Button>
                </form>
